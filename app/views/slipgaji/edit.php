                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <select class="form-control" id="Bulan" name="Bulan" required>
                                    <?php for ($i = 1; $i <= 12; $i++): ?>
                                        <option value="<?= $i ?>" <?= $slipGaji['Bulan'] == $i ? 'selected' : '' ?>>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" id="Tahun" name="Tahun" 
                                       value="<?= $slipGaji['Tahun'] ?>" min="2000" max="2100" required>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control" id="Tanggal_Dibuat" name="Tanggal_Dibuat" 
                                       value="<?= !empty($slipGaji['Tanggal_Dibuat']) ? date('Y-m-d', strtotime($slipGaji['Tanggal_Dibuat'])) : '' ?>" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" id="Tunjangan_Transportasi" name="Tunjangan_Transportasi" 
                                       value="<?= $slipGaji['Tunjangan_Transportasi'] ?>" min="0">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" id="Tunjangan_Kesehatan" name="Tunjangan_Kesehatan" 
                                       value="<?= $slipGaji['Tunjangan_Kesehatan'] ?>" min="0">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" id="Tunjangan_Lainnya" name="Tunjangan_Lainnya" 
                                       value="<?= $slipGaji['Tunjangan_Lainnya'] ?>" min="0">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" id="Potongan_Tetap" name="Potongan_Tetap" 
                                       value="<?= $slipGaji['Potongan_Tetap'] ?>" min="0">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="Potongan_Lainnya" class="form-label">Potongan Lainnya</label>
                                <input type="number" class="form-control" id="Potongan_Lainnya" name="Potongan_Lainnya" 
                                       value="<?= $slipGaji['Potongan_Lainnya'] ?>" min="0">
                            </div>
                        </div>
                    </div>
